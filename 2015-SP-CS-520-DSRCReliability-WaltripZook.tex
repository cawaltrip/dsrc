...
% TODO (Chris): Change all instances of Wi-Fi to WLAN?  It's probably a better way to describe U-NII devices.  The Park article refer to 10 MHz and 20 MHz devices as WAVE and WLAN respectively and this may be the best way to do it.
